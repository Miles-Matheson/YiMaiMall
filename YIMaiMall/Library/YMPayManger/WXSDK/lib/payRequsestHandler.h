...
#define APP_ID          @"wx08e39bf74cbc57e4"               //APPID
#define APP_SECRET      @"9ECF2556015C73226F8FCCC172C3529F" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1286715001"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"9ECF2556015C73226F8FCCC172C3529F"
//支付结果回调页面
...
//签名实例测试
- ( NSMutableDictionary *)sendPay_demo:(Order*)order;
