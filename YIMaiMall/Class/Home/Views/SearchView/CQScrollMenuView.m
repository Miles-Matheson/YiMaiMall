...
- (void)setTitleArray:(NSArray *)titleArray{
    ...
    [_titleArray enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [menuButton setTitleColor:kAppThemeColor forState:UIControlStateSelected];
        ...
        if (idx == 0) {
            ...
            _lineView.backgroundColor = kAppThemeColor;
        }
...
//     改变按钮的选中状态
    ...
    if ([self.menuButtonClickedDelegate respondsToSelector:@selector(scrollMenuView:clickItemAtIndex:)]) {
        [self.menuButtonClickedDelegate scrollMenuView:self clickItemAtIndex:(sender.tag - 100)];
    }
}
