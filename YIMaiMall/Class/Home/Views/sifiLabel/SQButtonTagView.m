...
const static NSInteger _buttonTag = 101;
...
-(void)setCurrentSelectIndexs:(NSArray *)currentSelectIndexs
{
    _currentSelectIndexs = currentSelectIndexs;
    
    self.selectArray = _currentSelectIndexs.copy;
}
...
- (void)refreshView{
        ...
        for (UIButton *buttonTag in self.buttonTags) {
            if ([self.selectArray containsObject:@(buttonTag.tag-101)]) {
                ...
                [buttonTag setBackgroundColor:RGB(240, 240, 240)];
