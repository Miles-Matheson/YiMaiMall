...
-(void)initUI{
    ...
    _shopNameLB = [ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"美丽人生旗舰店" textColor:kAppSubThemeColor textAlignment:Left font:kFont14];
    ...
    _scoreLB = [ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"综合评分 9.3" textColor:kAppSubThemeColor textAlignment:Left font:kFont14];
    ...
    
    {
        ...
        _foxNumLB =[ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"288" textColor:RGB(51, 51, 51) textAlignment:Center font:kFont14];
        ...
        _goodsNumLB =[ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"300" textColor:RGB(51, 51, 51) textAlignment:Center font:kFont14];
...

    {
        ...
        [title3 mas_makeConstraints:^(MASConstraintMaker *make) {
         ...
         /*********************************************/
        _goodsScoreLB =[ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"4.5" textColor:kAppSubThemeColor textAlignment:Left font:kFont11];
        ...
        _shopScoreLB =[ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"1.3" textColor:kAppSubThemeColor textAlignment:Left font:kFont11];
