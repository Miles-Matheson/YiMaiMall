...
#import "OnlineBaseController.h"

@interface OnlineBaseController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation OnlineBaseController
