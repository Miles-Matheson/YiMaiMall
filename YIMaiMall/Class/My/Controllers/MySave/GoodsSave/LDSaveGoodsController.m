...
#import "LDSaveGoodsController.h"

#import "LDGoodsOnlineController.h"
#import "LDGoodsOfflineController.h"

@interface LDSaveGoodsController ()

@property (nonatomic,strong)NSArray *titleArray;

@end

@implementation LDSaveGoodsController
...
- (void)initViewControllers {
    ...
    NSMutableArray * vcArray = [[NSMutableArray alloc]init];
        ...
        for (int i = 0; i<self.titleArray.count; i++) {
            ...
            if (i == 0) {
                LDGoodsOnlineController *onLineVC = [[LDGoodsOnlineController alloc]init];
                 onLineVC.yp_tabItemTitle = self.titleArray[i];
                  [vcArray addObject:onLineVC];
            }else{
                LDGoodsOfflineController *onLineVC = [[LDGoodsOfflineController alloc]init];
                onLineVC.yp_tabItemTitle = self.titleArray[i];
                [vcArray addObject:onLineVC];
            }
        }
