...
- (void)loadImageNearIndex:(int)index
{
    if (index > 0) {
        ...
        [[SDWebImageDownloader sharedDownloader] downloadImageWithURL:photo.url options:SDWebImageRetryFailed|SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
            //do nothing
